...
class View(tkinter.Tk):
    ...
    def __init__(self, controller):
        ...
        self.bind('<Enter>', self.controller.handleButtonSearch)
    ...
    def _createFrameDetails(self):
        ...
        labelConditionRight.grid(row=0, column=1, pady=5, stick=E)
        labelFeelsLikeLeft.grid(row=1, column=0, pady=5, sticky=W)
        labelFeelsLikeRight.grid(row=1, column=1, pady=5, stick=E)
        labelWindSpeedLeft.grid(row=2, column=0, pady=5, sticky=W)
        labelWindSpeedRight.grid(row=2, column=1, pady=5, stick=E)
        labelWindDirLeft.grid(row=3, column=0, pady=5, sticky=W)
        labelWindDirRight.grid(row=3, column=1, pady=5, stick=E)
    ...
    def _createFrameControls(self):
        ...
        radioC = Radiobutton(self.frameControls, text='Celsius', variable=self.varUnits, value=2, command=self.controller.updateGUI)
